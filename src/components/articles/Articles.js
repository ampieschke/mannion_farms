      ...
      <div className="container">
        ...
        >
          ...
          <Modal.Body>
            ...
            The Paul Bunyan Trophy, The Subway Series, whatever they call it
            when the Jaguars and Dolphins play; we all know these fierce
            rivalries well. Yet they pale in comparison when it comes to the
            hype surrounding this matchup in Mannion Farms Fantasy Football. To
            state the obvious, I’m writing about the Week 6 meeting of Missy’s
            Darn Good Tootsies and the Hamburglars - The Andys Bowl. This will
            be the first opportunity for a team to bring home silverware in the
            2021 season as these 2 storied SFC franchises slug it out for the
            Kourage Trophy.
            <br />
            <br />
            ...
            disappointed to start the 2021 season, each coming in on fire as
            early playoff contenders and the #1 (Hamburglars) and #3 (Tootsies)
            teams in total scoring.
            <br />
            <br />
            The 2020 showdown was one for the ages. Andys everywhere remember
            exactly where they were as they watched a Monday Night matchup
            between the Saints and Chargers with Alvin Kamara traipsing about
            for 119 total yards to secure a glorious 1.6-point victory for the
            Tootsies and manager Andrew Chappell.
            <br />
            <br />
